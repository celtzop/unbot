const config = {
    ...
    users: {
        ownerId: '547499924997275653', // The bot owner ID, which is you.
        developers: ['547499924997275653', '1270139557395959901'] // The bot developers, remember to include your account ID with the other account IDs.
    },
